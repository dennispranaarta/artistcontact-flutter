...
class _EditScreenState extends State<EditScreen> {
  ...
  void initState() {
    super.initState();
    _titleController.text = widget.object.titleIssues;
  }
  ...
  Future<void> _updateDataWithImage(BuildContext context) async {
    ...
    var request = MultipartRequest(
        'POST', Uri.parse('${Endpoints.datas}/${widget.object.idCustomerService}'));
